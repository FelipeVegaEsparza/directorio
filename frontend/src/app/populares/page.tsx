...
import { usePopularMedia } from '@/hooks/useMedia';
...
export default function PopularPage() {
  ...
  const { popularMedia, loading, error } = usePopularMedia();
      ...
      <NoSSR>
        <div className="bg-secondary-50 min-h-screen">
            ...
            <div className="container py-12">
              ...
              <div className="text-center">
                ...
                <p className="text-xl text-primary-100 max-w-2xl mx-auto">
                  Los canales y radios con mayor audiencia
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container py-12">
            ...
            {!loading && !error && (!popularMedia || popularMedia.length === 0) && (
              <div className="text-center py-12">
                <div className="text-6xl mb-4 opacity-50">🔥</div>
                <h3 className="text-2xl font-bold text-secondary-900 mb-2">
                  No hay contenido popular
                </h3>
                <p className="text-secondary-600 mb-6">
                  Aún no tenemos estadísticas de popularidad disponibles.
                </p>
