...
export default function FeaturedPage() {
  ...
  const { featuredMedia, loading, error } = useFeaturedMedia();
      ...
      <NoSSR>
        <div className="bg-secondary-50 min-h-screen">
            ...
            <div className="container py-12">
              ...
              <div className="text-center">
                ...
                <p className="text-xl text-primary-100 max-w-2xl mx-auto">
                  Los mejores canales y radios seleccionados especialmente para ti
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container py-12">
            ...
            {!loading && !error && (!featuredMedia || featuredMedia.length === 0) && (
              <div className="text-center py-12">
                ...
                <p className="text-secondary-600 mb-6">
                  Aún no tenemos contenido destacado disponible.
                </p>
