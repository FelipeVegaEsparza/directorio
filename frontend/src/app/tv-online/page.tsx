...
export default function TVOnlinePage() {
            ...
            <div className="container py-12">
              ...
              <div className="text-center">
                ...
                <p className="text-xl text-primary-100 max-w-2xl mx-auto">
                  Disfruta de los mejores canales de televisión en vivo
                </p>
                {media && media.length > 0 && pagination && (
                  <p className="text-primary-200 mt-2">
                    {pagination.total} {pagination.total === 1 ? 'canal encontrado' : 'canales encontrados'}
                  </p>
                )}
              </div>
            </div>
            ...
            {error ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-secondary-600 mb-6">
                  Aún no tenemos canales de TV registrados en nuestro directorio.
                </p>
